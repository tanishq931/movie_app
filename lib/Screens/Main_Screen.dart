                                    ...
                                    return InkWell(
                                      onTap: () {
                                        Navigator.push(context,
                                            MaterialPageRoute(
                                                builder: (context) =>
                                                    MyMovieDetailPage(imgsrc1: data['results'][index]['poster_path']==null?data['results'][index]['backdrop_path']:data['results'][index]['poster_path'],
                                                    titletext: data['results'][index]['title'],daterel1: data['results'][index]['release_date'],description: data['results'][index]['overview'],
                                                      rate: data['results'][index]['vote_average'].toString(),origlang1: data['results'][index]['original_language'],movieidresult: data['results'][index]['id'],
                                                    )));
                                      },
                                      child: Stack(
                                        children: [
